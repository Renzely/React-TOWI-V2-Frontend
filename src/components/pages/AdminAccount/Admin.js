...
export default function Admin() {
  ...
  const handleBranchSave = async (email) => {
    try {
      const response = await axios.put(
        "https://towi-react.onrender.com/update-admin-outlet",
        {
  ...
  const outlets = ["PUREGOLD PRICE CLUB - LA TRINIDAD BENGUET", "Branch"];
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await axios.post(
        "https://towi-react.onrender.com/update-coor-details",
        {
  ...
  //   try {
  //     const response = await axios.post(
  //       "https://towi-react.onrender.com/get-all-merchandiser"
  //     );
  //     const data = response.data.data;
  ...
  async function getUser() {
    try {
      const response = await axios.post(
        "https://towi-react.onrender.com/get-admin-user",
        requestBody
      );
      const data = response.data.data;
  ...
  async function setStatus() {
    await axios
      .put("https://towi-react.onrender.com/update-admin-status", requestBody)
      .then(async (response) => {
  ...
  async function sendOtp() {
    ...
    await axios
      .post("https://towi-react.onrender.com/send-otp", {
        email: adminEmail,
      })
      .then(async (response) => {
  ...
  async function confirmOtp() {
    if (otpCode === inputOtpCode) {
      ...
      axios
        .post(
          "https://towi-react.onrender.com/register-user-admin",
          userDetails
        )
        .then(async (response) => {
