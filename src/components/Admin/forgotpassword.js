...
import backgroundImage from "./towi_logo.png";
...
export default function ForgotPassword() {
  ...
  const handleSubmitEmail = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://towi-react.onrender.com/send-otp-forgotpassword",
  ...
  const handleSubmitResetPassword = async (event) => {
    ...
    axios
      .put("https://towi-react.onrender.com/forgot-password-reset", body)
      .then(async (response) => {
    ...
    <ThemeProvider theme={theme}>
      <Grid
        ...
        sx={{
          height: "100vh",
          background:
            "linear-gradient(135deg, #98FBCB, #BFFFED, #7FCFA8, #558B71)",
